...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SupportState<T>);
}
...
/// @nodoc
class $SupportStateCopyWith<T,$Res>  {
$SupportStateCopyWith(SupportState<T> _, $Res Function(SupportState<T>) __);
}


/// Adds pattern-matching-related methods to [SupportState].
extension SupportStatePatterns<T> on SupportState<T> {
...
class _Initial<T> implements SupportState<T> {
  const _Initial();
...
class _Loading<T> implements SupportState<T> {
  const _Loading();
...
class _Success<T> implements SupportState<T> {
...
@override
String toString() {
  return 'SupportState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $SupportStateCopyWith<T, $Res> {
...
class _Error<T> implements SupportState<T> {
...
@override
String toString() {
  return 'SupportState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $SupportStateCopyWith<T, $Res> {
