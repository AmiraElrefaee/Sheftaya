...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChangePasswordState<T>);
}
...
/// @nodoc
class $ChangePasswordStateCopyWith<T,$Res>  {
$ChangePasswordStateCopyWith(ChangePasswordState<T> _, $Res Function(ChangePasswordState<T>) __);
}


/// Adds pattern-matching-related methods to [ChangePasswordState].
extension ChangePasswordStatePatterns<T> on ChangePasswordState<T> {
...
class _Initial<T> implements ChangePasswordState<T> {
  const _Initial();
...
class _Loading<T> implements ChangePasswordState<T> {
  const _Loading();
...
class _Success<T> implements ChangePasswordState<T> {
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $ChangePasswordStateCopyWith<T, $Res> {
...
class _Error<T> implements ChangePasswordState<T> {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $ChangePasswordStateCopyWith<T, $Res> {
