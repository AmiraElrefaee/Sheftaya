...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateProfileState<T>);
}
...
/// @nodoc
class $UpdateProfileStateCopyWith<T,$Res>  {
$UpdateProfileStateCopyWith(UpdateProfileState<T> _, $Res Function(UpdateProfileState<T>) __);
}


/// Adds pattern-matching-related methods to [UpdateProfileState].
extension UpdateProfileStatePatterns<T> on UpdateProfileState<T> {
...
class _Initial<T> implements UpdateProfileState<T> {
  const _Initial();
...
@override
String toString() {
  return 'UpdateProfileState<$T>.initial()';
}
...
class _Loading<T> implements UpdateProfileState<T> {
  const _Loading();
...
@override
String toString() {
  return 'UpdateProfileState<$T>.loading()';
}
...
class _Success<T> implements UpdateProfileState<T> {
...
@override
String toString() {
  return 'UpdateProfileState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $UpdateProfileStateCopyWith<T, $Res> {
...
class _Error<T> implements UpdateProfileState<T> {
...
@override
String toString() {
  return 'UpdateProfileState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $UpdateProfileStateCopyWith<T, $Res> {
