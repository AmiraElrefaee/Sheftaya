...
part of 'update_image_profile_state.dart';
...
/// @nodoc
mixin _$UpdateImageProfileState<T> {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UpdateImageProfileState<T>);
}
...
@override
String toString() {
  return 'UpdateImageProfileState<$T>()';
}
...
/// @nodoc
class $UpdateImageProfileStateCopyWith<T,$Res>  {
$UpdateImageProfileStateCopyWith(UpdateImageProfileState<T> _, $Res Function(UpdateImageProfileState<T>) __);
}


/// Adds pattern-matching-related methods to [UpdateImageProfileState].
extension UpdateImageProfileStatePatterns<T> on UpdateImageProfileState<T> {
...
class _Initial<T> implements UpdateImageProfileState<T> {
  const _Initial();
...
@override
String toString() {
  return 'UpdateImageProfileState<$T>.initial()';
}
...
class _Loading<T> implements UpdateImageProfileState<T> {
  const _Loading();
...
@override
String toString() {
  return 'UpdateImageProfileState<$T>.loading()';
}
...
class _Success<T> implements UpdateImageProfileState<T> {
  const _Success(this.data);
  

 final  T data;

/// Create a copy of UpdateImageProfileState
...
@override
String toString() {
  return 'UpdateImageProfileState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $UpdateImageProfileStateCopyWith<T, $Res> {
...
class _Error<T> implements UpdateImageProfileState<T> {
...
@override
String toString() {
  return 'UpdateImageProfileState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $UpdateImageProfileStateCopyWith<T, $Res> {
