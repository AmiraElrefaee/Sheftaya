...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ApplyJobState<T>);
}
...
/// @nodoc
class $ApplyJobStateCopyWith<T,$Res>  {
$ApplyJobStateCopyWith(ApplyJobState<T> _, $Res Function(ApplyJobState<T>) __);
}


/// Adds pattern-matching-related methods to [ApplyJobState].
extension ApplyJobStatePatterns<T> on ApplyJobState<T> {
...
class _Initial<T> implements ApplyJobState<T> {
  const _Initial();
...
@override
String toString() {
  return 'ApplyJobState<$T>.initial()';
}
...
class _Loading<T> implements ApplyJobState<T> {
  const _Loading();
...
@override
String toString() {
  return 'ApplyJobState<$T>.loading()';
}
...
class _Success<T> implements ApplyJobState<T> {
  const _Success(this.data);
  

 final  T data;

/// Create a copy of ApplyJobState
...
@override
String toString() {
  return 'ApplyJobState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $ApplyJobStateCopyWith<T, $Res> {
...
class _Error<T> implements ApplyJobState<T> {
...
@override
String toString() {
  return 'ApplyJobState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $ApplyJobStateCopyWith<T, $Res> {
