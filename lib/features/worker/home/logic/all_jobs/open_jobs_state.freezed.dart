...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OpenJobsState);
}
...
/// @nodoc
class $OpenJobsStateCopyWith<$Res>  {
$OpenJobsStateCopyWith(OpenJobsState _, $Res Function(OpenJobsState) __);
}
...
class _Initial implements OpenJobsState {
  const _Initial();
...
class _Loading implements OpenJobsState {
  const _Loading();
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $OpenJobsStateCopyWith<$Res> {
...
class _Error implements OpenJobsState {
...
@override
String toString() {
  return 'OpenJobsState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $OpenJobsStateCopyWith<$Res> {
