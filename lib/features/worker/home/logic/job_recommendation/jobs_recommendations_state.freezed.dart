...
part of 'jobs_recommendations_state.dart';
...
/// @nodoc
mixin _$JobsRecommendationsState<T> {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is JobsRecommendationsState<T>);
}
...
@override
String toString() {
  return 'JobsRecommendationsState<$T>()';
}
...
/// @nodoc
class $JobsRecommendationsStateCopyWith<T,$Res>  {
$JobsRecommendationsStateCopyWith(JobsRecommendationsState<T> _, $Res Function(JobsRecommendationsState<T>) __);
}


/// Adds pattern-matching-related methods to [JobsRecommendationsState].
extension JobsRecommendationsStatePatterns<T> on JobsRecommendationsState<T> {
...
class _Initial<T> implements JobsRecommendationsState<T> {
  const _Initial();
...
@override
String toString() {
  return 'JobsRecommendationsState<$T>.initial()';
}
...
class _Loading<T> implements JobsRecommendationsState<T> {
  const _Loading();
...
@override
String toString() {
  return 'JobsRecommendationsState<$T>.loading()';
}
...
class _Success<T> implements JobsRecommendationsState<T> {
  const _Success(this.data);
  

 final  T data;

/// Create a copy of JobsRecommendationsState
...
@override
String toString() {
  return 'JobsRecommendationsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<T,$Res> implements $JobsRecommendationsStateCopyWith<T, $Res> {
...
class _Error<T> implements JobsRecommendationsState<T> {
...
@override
String toString() {
  return 'JobsRecommendationsState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<T,$Res> implements $JobsRecommendationsStateCopyWith<T, $Res> {
