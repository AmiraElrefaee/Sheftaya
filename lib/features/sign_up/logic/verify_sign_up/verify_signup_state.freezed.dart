...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerifySignupState<T>);
}
...
/// @nodoc
class $VerifySignupStateCopyWith<T,$Res>  {
$VerifySignupStateCopyWith(VerifySignupState<T> _, $Res Function(VerifySignupState<T>) __);
}


/// Adds pattern-matching-related methods to [VerifySignupState].
extension VerifySignupStatePatterns<T> on VerifySignupState<T> {
...
class _Initial<T> implements VerifySignupState<T> {
  const _Initial();
...
@override
String toString() {
  return 'VerifySignupState<$T>.initial()';
}
...
class Loading<T> implements VerifySignupState<T> {
  const Loading();
...
@override
String toString() {
  return 'VerifySignupState<$T>.loading()';
}
...
class Success<T> implements VerifySignupState<T> {
...
@override
String toString() {
  return 'VerifySignupState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $VerifySignupStateCopyWith<T, $Res> {
...
class Error<T> implements VerifySignupState<T> {
...
@override
String toString() {
  return 'VerifySignupState<$T>.error(error: $error)';
}
...
/// @nodoc
abstract mixin class $ErrorCopyWith<T,$Res> implements $VerifySignupStateCopyWith<T, $Res> {
